  ...
  const listArticles = [
    {
      ...
      img: "http://localhost:9000/pexels-camila-benítez-10970424.jpg",
      color: "black"
    },
    {
      id: 2,
      ...
      img: "http://localhost:9000/pexels-jhonny-salas-brochero-11847042.jpg",
      color: "black"
    },
    {
      id: 3,
      ...
      img: "http://localhost:9000/pexels-nacho-posse-9278713.jpg",
      color: "black"
    },
    {
      id: 4,
      ...
      img: "http://localhost:9000/pexels-emiliano-arano-4862568.jpg",
      color: "black"
    },
    {
      id: 5,
      ...
      img: "http://localhost:9000/pexels-micaela-alejandro-11289040.jpg",
      color: "black"
    },
  ];

  const articles = listArticles.map((article, index) => (
    <Appreciation key={index} article={article} />
  ));
  return (
    <footer>
